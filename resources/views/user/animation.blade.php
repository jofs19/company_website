...
.rotate-in-center{-webkit-animation:rotate-in-center 2s linear infinite alternate;animation:rotate-in-center 2s linear infinite alternate}
...
.flip-in-hor-bottom{-webkit-animation:flip-in-hor-bottom 2s cubic-bezier(.445,.05,.55,.95) infinite alternate both;animation:flip-in-hor-bottom 2s cubic-bezier(.445,.05,.55,.95) infinite alternate both}
