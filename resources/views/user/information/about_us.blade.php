...
<main class="container-fluid px-0">
    ...
    <section class="row g-0">
      <div class="col-md-6 bg-position-center bg-size-cover bg-secondary" style="min-height: 15rem; background-image: url(https://info.asciidevsystem.com/wp-content/uploads/2022/05/experts-2114346413.jpg);"></div>
      <div class="col-md-6 px-3 px-md-5 py-5">
        <div class="mx-auto py-lg-5" style="max-width: 35rem;">
          <h2 class="h3 pb-3">DESIGNED BY EXPERTS</h2>
          <p class="fs-sm pb-3 text-muted">More than our technology, it is our people you can trust. ASCII systems are designed, architected, and maintained by Financial Consultants, Certified Public Accountants and Subject Matter Experts.</p>
        </div>
      </div>
    </section>
    <!-- Row: Delivery-->
    <section class="row g-0">
      <div class="col-md-6 bg-position-center bg-size-cover bg-secondary order-md-2" style="min-height: 15rem; background-image: url(https://info.asciidevsystem.com/wp-content/uploads/2022/05/consultation-meeting-1.jpg);"></div>
      <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
        <div class="mx-auto py-lg-5" style="max-width: 35rem;">
          <h2 class="h3 pb-3">A TEAM THAT IS COMMITTED TO YOUR BUSINESS.</h2>
          <p class="fs-sm pb-3 text-muted">Everyone on our team doesn’t only speak the software language, we are also qualified and ready to talk with you about how our services help you achieve your business goals. </p>
        </div>
      </div>
    </section>
    <!-- Row: Mobile app-->
    <section class="row g-0">
      <div class="col-md-6 bg-position-center bg-size-cover bg-secondary" style="min-height: 15rem; background-image: url(https://info.asciidevsystem.com/wp-content/uploads/2022/05/business-04-3386840446-1.jpg);"></div>
      <div class="col-md-6 px-3 px-md-5 py-5">
        <div class="mx-auto py-lg-5" style="max-width: 35rem;">
          <h2 class="h3 pb-3">PIONEER IN BUSINESS SOLUTIONS</h2>
          <p class="fs-sm pb-3 text-muted">With more than 30 years of experience, we are proud to have earned the trust of different businesses from diverse industries and varying sizes.</p>
          {{-- <a class="btn-market btn-apple me-3 mb-3" href="#" role="button"><span class="btn-market-subtitle">Download on the</span><span class="btn-market-title">App Store</span></a> --}}
          {{-- <a class="btn-market btn-google mb-3" href="#" role="button"><span class="btn-market-subtitle">Download on the</span><span class="btn-market-title">Google Play</span></a> --}}
        </div>
      </div>
    </section>
